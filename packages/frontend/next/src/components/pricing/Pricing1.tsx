...
export default function Pricing1() {
  ...
  const planPrice = isAnnual ? "29" : "35";
  ...
  return (
    <main className="relative min-h-screen flex flex-col justify-center bg-[#181b3b] overflow-hidden">
      <div className="w-full max-w-6xl container px-4 md:px-6 py-24">
